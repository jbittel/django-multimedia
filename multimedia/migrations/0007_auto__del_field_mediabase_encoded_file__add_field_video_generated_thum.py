...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MediaBase.encoded_file'
        db.delete_column('multimedia_mediabase', 'encoded_file')

        # Adding field 'Video.generated_thumbnail'
        db.add_column('multimedia_video', 'generated_thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MediaBase.encoded_file'
        db.add_column('multimedia_mediabase', 'encoded_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Video.generated_thumbnail'
        db.delete_column('multimedia_video', 'generated_thumbnail')
    ...
    models = {
        ...
        'multimedia.video': {
            ...
            'auto_thumbnail': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'generated_thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'mediabase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['multimedia.MediaBase']", 'unique': 'True', 'primary_key': 'True'}),
            'thumbnail_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            'thumbnail_offset': ('django.db.models.fields.PositiveIntegerField', [], {'default': '4', 'blank': 'True'})
        }
