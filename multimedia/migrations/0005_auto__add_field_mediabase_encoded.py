...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MediaBase.encoded'
        db.add_column('multimedia_mediabase', 'encoded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MediaBase.encoded'
        db.delete_column('multimedia_mediabase', 'encoded')
