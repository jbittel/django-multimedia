...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MediaBase.profile'
        db.add_column('multimedia_mediabase', 'profile', self.gf('django.db.models.fields.CharField')(default='temp', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MediaBase.profile'
        db.delete_column('multimedia_mediabase', 'profile')
