...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RemoteStorage.content_hash'
        db.add_column(u'multimedia_remotestorage', 'content_hash',
                      self.gf('django.db.models.fields.CharField')(default='aaa', max_length=64),
                      keep_default=False)


        # Changing field 'RemoteStorage.profile'
        db.alter_column(u'multimedia_remotestorage', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multimedia.EncodeProfile'], on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting field 'RemoteStorage.content_hash'
        db.delete_column(u'multimedia_remotestorage', 'content_hash')


        # Changing field 'RemoteStorage.profile'
        db.alter_column(u'multimedia_remotestorage', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multimedia.EncodeProfile']))
