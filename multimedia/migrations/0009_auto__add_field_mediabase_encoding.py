...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MediaBase.encoding'
        db.add_column('multimedia_mediabase', 'encoding', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MediaBase.encoding'
        db.delete_column('multimedia_mediabase', 'encoding')
