...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RemoteStorage'
        db.create_table(u'multimedia_remotestorage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('media_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multimedia.EncodeProfile'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'multimedia', ['RemoteStorage'])


    def backwards(self, orm):
        # Deleting model 'RemoteStorage'
        db.delete_table(u'multimedia_remotestorage')
