...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EncodeProfile.file_type'
        raise RuntimeError("Cannot reverse this migration. 'EncodeProfile.file_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'EncodeProfile.file_type'
